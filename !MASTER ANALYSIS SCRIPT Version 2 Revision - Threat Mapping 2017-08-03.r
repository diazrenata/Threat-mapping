...
natureServeCounties$TIGERroadMiles <- natureServeCounties$TIGERroadLength/1.609344
natureServeCounties$TIGERroadDensity <- natureServeCounties$TIGERroadLength/natureServeCounties$SQMI
