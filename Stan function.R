...
runStanModel <- function(threat, predictors, states, ncores, CAR, scramble, justEndemics){
  ...
  workPath <- paste0('H:/Global Change Program/Research/Multi-Threat Assessment/Analysis - Threat Mapping/CAR beginning 07132017/CountyEndangeredSpecies-master/CAR Analyses/', threat, "_", predictorString, "_st", states, '_scr', scramble, '_CAR', CAR, "_", justEndemics)
  ...
  FitModel = sampling(StanModel,
                      ...
                      iter = 25,                 # total number of iterations per chain (includes warm-up)
                      cores = ncores,                    # number of cores
                      refresh = 5                # show progress every 'refresh' iterations
  )
